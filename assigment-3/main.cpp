...
{
    auto [iterations, x_hat] = math::gradient_descent_root_find(f, x0, 0.001, 0.5, 1e-3);
...
void ur3e_test_jacobian(const Eigen::VectorXd &joint_positions)
{
    ...
    std::cout << "Ad_tsb: " << std::endl << ad_tsb << std::endl;
    std::cout << "Ad_tbs: " << std::endl << ad_tbs << std::endl;
    std::cout << "Jb: " << std::endl << jb << std::endl << "Ad_tbs*Js:" << std::endl << ad_tbs * js <<std::endl << std::endl <<std::endl;
    std::cout << "Js: " << std::endl << js << std::endl << "Ad_tsb*Jb:" << std::endl << ad_tsb * jb <<std::endl << std::endl<<std::endl;;
    std::cout << "d Jb: " << std::endl << jb - ad_tbs * js << std::endl << std::endl<<std::endl;;
    std::cout << "d Js: " << std::endl << js - ad_tsb * jb << std::endl << std::endl<<std::endl;;
}
